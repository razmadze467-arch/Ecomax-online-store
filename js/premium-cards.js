...
(function(){
  ...
  style.textContent=`
    ...
    .ecomax-mini-car{position:absolute!important;width:62px;height:25px;filter:drop-shadow(0 0 10px var(--card-accent));will-change:transform;z-index:1000!important;display:block!important;visibility:visible!important;opacity:1!important}
    ...
    .ecomax-mini-car.one{left:0;top:4px;animation:ecomaxCardCarForward 3.8s linear infinite!important}
    .ecomax-mini-car.two{left:0;bottom:3px;animation:ecomaxCardCarBackward 4.6s linear infinite!important}
    @keyframes ecomaxCardCarForward{0%{transform:translate3d(-80px,0,0);opacity:1}100%{transform:translate3d(calc(100% + 80px),0,0);opacity:1}}
    @keyframes ecomaxCardCarBackward{0%{transform:translate3d(calc(100% + 80px),0,0);opacity:1}100%{transform:translate3d(-80px,0,0);opacity:1}}
