...
(function(){
  ...
  function addMovingCars(){
    ...
    style.textContent=`
      ...
      .ecomax-car-left{left:-130px;top:12%;animation:ecomaxCarLeft 8s linear infinite}
      .ecomax-car-right{left:-130px;bottom:12%;transform:scaleX(-1);animation:ecomaxCarRight 8.8s linear infinite}
      ...
      @media(max-width:650px){
        ...
        .ecomax-car-left{left:-100px} .ecomax-car-right{left:-100px}
      }
