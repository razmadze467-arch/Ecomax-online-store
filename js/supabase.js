...
(function(){
  ...
  window.ECOMAX_SUPABASE_CLIENT = original(SUPABASE_URL, SUPABASE_ANON_KEY, {
...
(function(){
  ...
  function js(id,src){if(document.getElementById(id))return;const x=document.createElement('script');x.id=id;x.src=src;x.defer=true;document.head.appendChild(x);}
  css('ecomaxEnhancementsCss','enhancements-v2.css?v=20260913-4');
  css('ecomaxStoreUiCss','store-ui.css?v=20260913-4');
  js('ecomaxStoreUiJs','store-ui.js?v=20260913-4');
  js('ecomaxFinalHomeJs','homepage-final.js?v=20260913-4');
})();