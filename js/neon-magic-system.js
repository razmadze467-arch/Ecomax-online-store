...
let badge=card.querySelector('.ecomax-mx-label');if(!badge){badge=document.createElement('div');badge.className='ecomax-mx-label';card.appendChild(badge)}badge.style.setProperty('--mx-a',color);badge.innerHTML=(A[x[3]]||A.engine)+'<b>'+x[2]+'</b><span>DETAILING SERIES</span>';
