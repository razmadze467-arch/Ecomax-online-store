...
async function syncAuthUI() {
  try {
    ...
    if (mobileNav && !mobileAccount) {
      ...
      mobileAccount.textContent = "áƒ©áƒ”áƒ›áƒ˜ áƒáƒœáƒ’áƒáƒ áƒ˜áƒ¨áƒ˜";
...
function renderCart() {
  ...
  if (!el) return;
  if (!cart.length) {
    el.innerHTML = '<div class="empty-cart"><div>ðŸ›’</div><h3>áƒ™áƒáƒšáƒáƒ—áƒ áƒªáƒáƒ áƒ˜áƒ”áƒšáƒ˜áƒ</h3><p>áƒ“áƒáƒáƒ›áƒáƒ¢áƒ” áƒžáƒ áƒáƒ“áƒ£áƒ¥áƒ¢áƒ˜ áƒ™áƒáƒšáƒáƒ—áƒáƒ¨áƒ˜.</p></div>';
    return;
  }
  el.innerHTML = cart.map((i, n) => `
    <div class="cart-item">
      <div class="cart-item-info"><strong>${esc(i.name)}</strong><span>${esc(i.volume)} Ã— ${i.quantity}</span></div>
      <div class="cart-item-price">${Number(i.price) * Number(i.quantity)} â‚¾</div>
      <button type="button" class="remove-item" data-index="${n}">Ã—</button>
    </div>`).join("");
}
...
function addToCart(name, price, volume) {
  ...
  if (!name || !Number.isFinite(price) || price <= 0) {
    note("áƒžáƒ áƒáƒ“áƒ£áƒ¥áƒ¢áƒ˜áƒ¡ áƒ“áƒáƒ›áƒáƒ¢áƒ”áƒ‘áƒ áƒ•áƒ”áƒ  áƒ›áƒáƒ®áƒ”áƒ áƒ®áƒ“áƒ");
    return;
  }
  ...
  updateCart();
  note(name + " áƒ“áƒáƒ”áƒ›áƒáƒ¢áƒ áƒ™áƒáƒšáƒáƒ—áƒáƒ¨áƒ˜");
}
...
function openCart() {
  ...
  if (!overlay) {
    note("áƒ™áƒáƒšáƒáƒ—áƒ˜áƒ¡ áƒ¤áƒáƒœáƒ¯áƒáƒ áƒ áƒ•áƒ”áƒ  áƒ›áƒáƒ˜áƒ«áƒ”áƒ‘áƒœáƒ");
    return;
  }
...
function volumeUpdate(card) {
  ...
  const label = volume === 0.5 ? "500 áƒ›áƒš" : volume + " áƒšáƒ˜áƒ¢áƒ áƒ˜";
...
function checkout() {
  if (!cart.length) {
    note("áƒ™áƒáƒšáƒáƒ—áƒ áƒªáƒáƒ áƒ˜áƒ”áƒšáƒ˜áƒ");
    return;
  }
  save();
...
function addFutureDesign() {
  ...
  section.innerHTML = `
    <div class="ecomax-future-head">
      <div>
        <div class="ecomax-future-kicker">ECOMAX â€¢ AUTO CARE EXPERIENCE</div>
        <h2>áƒ›áƒáƒœáƒ¥áƒáƒœáƒ˜áƒ¡ áƒ›áƒáƒ•áƒšáƒ<br><span>áƒáƒ®áƒáƒšáƒ˜ áƒ”áƒœáƒ”áƒ áƒ’áƒ˜áƒ˜áƒ—.</span></h2>
      </div>
      <p>
        áƒ¡áƒ˜áƒ¡áƒ£áƒ¤áƒ—áƒáƒ•áƒ” áƒ›áƒ®áƒáƒšáƒáƒ“ áƒ‘áƒ–áƒ˜áƒœáƒ•áƒáƒ áƒ”áƒ‘áƒ áƒáƒ  áƒáƒ áƒ˜áƒ¡. áƒ¡áƒ¬áƒáƒ áƒ˜ áƒ›áƒáƒ•áƒšáƒ áƒœáƒ˜áƒ¨áƒœáƒáƒ•áƒ¡ áƒ«áƒáƒ áƒ˜áƒ¡, áƒ¡áƒáƒšáƒáƒœáƒ˜áƒ¡,
        áƒ›áƒ˜áƒœáƒ˜áƒ¡, áƒ‘áƒáƒ áƒ‘áƒšáƒ”áƒ‘áƒ˜áƒ¡, áƒ¡áƒáƒ‘áƒ£áƒ áƒáƒ•áƒ”áƒ‘áƒ˜áƒ¡, áƒ«áƒ áƒáƒ•áƒ˜áƒ¡áƒ áƒ“áƒ áƒ§áƒ•áƒ”áƒšáƒ áƒ›áƒœáƒ˜áƒ¨áƒ•áƒœáƒ”áƒšáƒáƒ•áƒáƒœáƒ˜ áƒ–áƒ”áƒ“áƒáƒžáƒ˜áƒ áƒ˜áƒ¡
        áƒ§áƒ£áƒ áƒáƒ“áƒ¦áƒ”áƒ‘áƒ˜áƒ— áƒ›áƒáƒ•áƒšáƒáƒ¡. ECOMAX áƒ¨áƒ”áƒ¥áƒ›áƒœáƒ˜áƒšáƒ˜áƒ áƒ˜áƒ›áƒ˜áƒ¡áƒ—áƒ•áƒ˜áƒ¡, áƒ áƒáƒ› áƒ§áƒáƒ•áƒ”áƒšáƒ“áƒ¦áƒ˜áƒ£áƒ áƒ˜ áƒ¬áƒ›áƒ”áƒœáƒ“áƒ
        áƒžáƒ áƒáƒ¤áƒ”áƒ¡áƒ˜áƒáƒœáƒáƒšáƒ£áƒ  áƒ’áƒáƒ›áƒáƒªáƒ“áƒ˜áƒšáƒ”áƒ‘áƒáƒ“ áƒáƒ¥áƒªáƒ˜áƒáƒ¡.
      </p>
    </div>
    ...
    <div class="ecomax-care-grid">
      <article class="ecomax-care-card">
        ...
        <h3>áƒ«áƒáƒ áƒ˜áƒ¡ áƒ¡áƒ˜áƒ¡áƒ£áƒ¤áƒ—áƒáƒ•áƒ” áƒ“áƒ áƒ‘áƒ–áƒ˜áƒœáƒ•áƒáƒ áƒ”áƒ‘áƒ</h3>
        <p>áƒ›áƒ¢áƒ•áƒ”áƒ áƒ˜, áƒ’áƒ–áƒ˜áƒ¡ áƒ­áƒ£áƒ­áƒ§áƒ˜, áƒªáƒ®áƒ˜áƒ›áƒáƒ•áƒáƒœáƒ˜ áƒ™áƒ•áƒáƒšáƒ˜ áƒ“áƒ áƒ§áƒáƒ•áƒ”áƒšáƒ“áƒ¦áƒ˜áƒ£áƒ áƒ˜ áƒ“áƒáƒ‘áƒ˜áƒœáƒ«áƒ£áƒ áƒ”áƒ‘áƒ â€” áƒ¡áƒ¬áƒáƒ áƒ˜ áƒ¥áƒ˜áƒ›áƒ˜áƒ˜áƒ¡áƒ áƒ“áƒ áƒ¡áƒ¬áƒáƒ áƒ˜ áƒ’áƒáƒ–áƒáƒ•áƒ”áƒ‘áƒ˜áƒ¡ áƒáƒ áƒ©áƒ”áƒ•áƒ áƒ–áƒ”áƒ“áƒáƒžáƒ˜áƒ áƒ¡ áƒ¡áƒ£áƒ¤áƒ—áƒáƒ“ áƒ“áƒ áƒ›áƒáƒ•áƒšáƒ˜áƒšáƒáƒ“ áƒ¢áƒáƒ•áƒ”áƒ‘áƒ¡.</p>
      </article>
      <article class="ecomax-care-card">
        <div class="ecomax-care-number">02 / ENGINE</div>
        <h3>áƒ«áƒ áƒáƒ•áƒ˜áƒ¡ áƒ¡áƒ˜áƒ¡áƒ£áƒ¤áƒ—áƒáƒ•áƒ”</h3>
        <p>áƒ«áƒ áƒáƒ•áƒ˜áƒ¡ áƒ¡áƒ˜áƒ•áƒ áƒªáƒ˜áƒ¡ áƒ›áƒáƒ•áƒšáƒ áƒ›áƒáƒ˜áƒ—áƒ®áƒáƒ•áƒ¡ áƒ§áƒ£áƒ áƒáƒ“áƒ¦áƒ”áƒ‘áƒáƒ¡, áƒ™áƒáƒœáƒ¢áƒ áƒáƒšáƒ˜áƒ áƒ”áƒ‘áƒ£áƒš áƒ¬áƒ›áƒ”áƒœáƒ“áƒáƒ¡ áƒ“áƒ áƒ£áƒ¡áƒáƒ¤áƒ áƒ—áƒ®áƒ áƒ’áƒáƒ›áƒáƒ§áƒ”áƒœáƒ”áƒ‘áƒáƒ¡. áƒ«áƒšáƒ˜áƒ”áƒ áƒ˜ áƒ“áƒáƒ‘áƒ˜áƒœáƒ«áƒ£áƒ áƒ”áƒ‘áƒ˜áƒ¡áƒ—áƒ•áƒ˜áƒ¡ áƒ’áƒáƒ›áƒáƒ˜áƒ§áƒ”áƒœáƒ” áƒ¨áƒ”áƒ¡áƒáƒ‘áƒáƒ›áƒ˜áƒ¡áƒ˜ áƒ’áƒáƒ–áƒáƒ•áƒ”áƒ‘áƒ.</p>
      </article>
      <article class="ecomax-care-card">
        <div class="ecomax-care-number">03 / INTERIOR</div>
        <h3>áƒ¡áƒáƒšáƒáƒœáƒ˜áƒ¡ áƒ¡áƒ£áƒ¤áƒ—áƒ áƒ¡áƒ˜áƒ•áƒ áƒªáƒ”</h3>
        <p>áƒ¢áƒ§áƒáƒ•áƒ˜, áƒ¥áƒ¡áƒáƒ•áƒ˜áƒšáƒ˜, áƒžáƒšáƒáƒ¡áƒ¢áƒ›áƒáƒ¡áƒ áƒ“áƒ áƒ¡áƒ®áƒ•áƒ áƒ¡áƒáƒšáƒáƒœáƒ˜áƒ¡ áƒ–áƒ”áƒ“áƒáƒžáƒ˜áƒ áƒ”áƒ‘áƒ˜ áƒ¡áƒ®áƒ•áƒáƒ“áƒáƒ¡áƒ®áƒ•áƒ áƒ›áƒ˜áƒ“áƒ’áƒáƒ›áƒáƒ¡ áƒ¡áƒáƒ­áƒ˜áƒ áƒáƒ”áƒ‘áƒ¡. áƒ›áƒáƒ•áƒšáƒ˜áƒšáƒ˜ áƒ˜áƒœáƒ¢áƒ”áƒ áƒ˜áƒ”áƒ áƒ˜ áƒ›áƒáƒœáƒ¥áƒáƒœáƒ˜áƒ¡ áƒ¡áƒáƒ”áƒ áƒ—áƒ áƒ®áƒáƒ áƒ˜áƒ¡áƒ®áƒ¡ áƒªáƒ•áƒšáƒ˜áƒ¡.</p>
      </article>
      <article class="ecomax-care-card">
        <div class="ecomax-care-number">04 / WHEELS</div>
        <h3>áƒ“áƒ˜áƒ¡áƒ™áƒ”áƒ‘áƒ˜ áƒ“áƒ áƒ¡áƒáƒ‘áƒ£áƒ áƒáƒ•áƒ”áƒ‘áƒ˜</h3>
        <p>áƒ‘áƒáƒ áƒ‘áƒšáƒ”áƒ‘áƒ˜ áƒ§áƒáƒ•áƒ”áƒšáƒ“áƒ¦áƒ˜áƒ£áƒ áƒáƒ“ áƒ˜áƒ¦áƒ”áƒ‘áƒ¡ áƒ›áƒ¢áƒ•áƒ”áƒ áƒ¡, áƒ¢áƒáƒšáƒáƒ®áƒ¡ áƒ“áƒ áƒ’áƒ–áƒ˜áƒ¡ áƒœáƒáƒ áƒ©áƒ”áƒœáƒ”áƒ‘áƒ¡. áƒ áƒ”áƒ’áƒ£áƒšáƒáƒ áƒ£áƒšáƒ˜ áƒ’áƒáƒ¬áƒ›áƒ”áƒœáƒ“áƒ áƒ›áƒáƒœáƒ¥áƒáƒœáƒ˜áƒ¡ áƒ•áƒ˜áƒ–áƒ£áƒáƒšáƒ£áƒ  áƒ˜áƒ”áƒ áƒ¡ áƒ‘áƒ”áƒ•áƒ áƒáƒ“ áƒ£áƒ¤áƒ áƒ áƒ›áƒ™áƒ•áƒ”áƒ—áƒ áƒ¡ áƒ®áƒ“áƒ˜áƒ¡.</p>
      </article>
      <article class="ecomax-care-card">
        <div class="ecomax-care-number">05 / DETAILING</div>
        <h3>áƒ“áƒ”áƒ¢áƒ”áƒ˜áƒšáƒ˜áƒœáƒ’áƒ˜áƒ¡ áƒ”áƒ¤áƒ”áƒ¥áƒ¢áƒ˜</h3>
        <p>áƒžáƒáƒ¢áƒáƒ áƒ áƒ“áƒ”áƒ¢áƒáƒšáƒ”áƒ‘áƒ˜ áƒ¥áƒ›áƒœáƒ˜áƒ¡ áƒ“áƒ˜áƒ“ áƒ’áƒáƒœáƒ¡áƒ®áƒ•áƒáƒ•áƒ”áƒ‘áƒáƒ¡ â€” áƒ¡áƒ£áƒ¤áƒ—áƒ áƒ–áƒ”áƒ“áƒáƒžáƒ˜áƒ áƒ˜, áƒ›áƒáƒ¬áƒ”áƒ¡áƒ áƒ˜áƒ’áƒ”áƒ‘áƒ£áƒšáƒ˜ áƒ¡áƒáƒšáƒáƒœáƒ˜, áƒ›áƒáƒ•áƒšáƒ˜áƒšáƒ˜ áƒžáƒšáƒáƒ¡áƒ¢áƒ›áƒáƒ¡áƒ˜ áƒ“áƒ áƒ‘áƒáƒ áƒ‘áƒšáƒ”áƒ‘áƒ˜ áƒ¥áƒ›áƒœáƒ˜áƒ¡ áƒžáƒ áƒáƒ¤áƒ”áƒ¡áƒ˜áƒáƒœáƒáƒšáƒ£áƒ  áƒ˜áƒ”áƒ áƒ¡.</p>
      </article>
      <article class="ecomax-care-card">
        <div class="ecomax-care-number">06 / ECOMAX</div>
        <h3>áƒžáƒ áƒáƒ¤áƒ”áƒ¡áƒ˜áƒáƒœáƒáƒšáƒ£áƒ áƒ˜ áƒ›áƒ˜áƒ“áƒ’áƒáƒ›áƒ</h3>
        <p>áƒáƒ˜áƒ áƒ©áƒ˜áƒ” áƒžáƒ áƒáƒ“áƒ£áƒ¥áƒ¢áƒ˜ áƒ“áƒáƒ‘áƒ˜áƒœáƒ«áƒ£áƒ áƒ”áƒ‘áƒ˜áƒ¡ áƒ¢áƒ˜áƒžáƒ˜áƒ¡ áƒ›áƒ˜áƒ®áƒ”áƒ“áƒ•áƒ˜áƒ—, áƒ“áƒáƒ˜áƒªáƒáƒ•áƒ˜ áƒ áƒ”áƒ™áƒáƒ›áƒ”áƒœáƒ“áƒ”áƒ‘áƒ£áƒšáƒ˜ áƒ’áƒáƒ–áƒáƒ•áƒ”áƒ‘áƒ áƒ“áƒ áƒ˜áƒ›áƒ£áƒ¨áƒáƒ•áƒ” áƒ”áƒ¢áƒáƒžáƒáƒ‘áƒ áƒ˜áƒ•áƒáƒ“ â€” áƒ¨áƒ”áƒ“áƒ”áƒ’áƒ˜ áƒ£áƒ¤áƒ áƒ áƒ¡áƒ£áƒ¤áƒ—áƒ, áƒ—áƒáƒœáƒáƒ‘áƒáƒ áƒ˜ áƒ“áƒ áƒ™áƒáƒœáƒ¢áƒ áƒáƒšáƒ˜áƒ áƒ”áƒ‘áƒáƒ“áƒ˜ áƒ˜áƒ¥áƒœáƒ”áƒ‘áƒ.</p>
      </article>
    </div>
